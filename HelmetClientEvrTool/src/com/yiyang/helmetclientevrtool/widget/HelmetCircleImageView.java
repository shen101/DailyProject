package com.yiyang.helmetclientevrtool.widget;
...
public class HelmetCircleImageView extends ImageView {

	private Paint mPaint, circle_paint;
	private int mWidth;
	private int mHeight;
	...
	public HelmetCircleImageView(Context context) {
		this(context, null);
		// TODO Auto-generated constructor stub
	}

	public HelmetCircleImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		// TODO Auto-generated constructor stub
	}

	public HelmetCircleImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onDraw(Canvas canvas) {
		...
		setBitmapShader();
		if (mType == TYPE_CIRCLE) {
			canvas.drawCircle(mRadius, mRadius, mRadius, circle_paint);
	...
	/**
	 * 矩形圆角 view.setType(ZQImageViewRoundOval.TYPE_ROUND);
	 * view.setRoundRadius(6);//矩形凹行大小 椭圆
	 * view.setType(ZQImageViewRoundOval.TYPE_OVAL); view.setRoundRadius(45);//
	 * 圆角大小
	 */
}
